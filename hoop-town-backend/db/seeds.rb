...
Tournament.create(name: "Aim High", venue: "Classon Park", street: "432 Classon Road", city: "Brookyln", state: "NY", zipcode: 11238, date_time: DateTime.parse("13/04/2021 14:00"), host: "Netz", about: "You already know what it is, the annual classon tournament.")
Tournament.create(name: "Dreamers", venue: "ACD Arena", street: "85 Arlington Steet", city: "Bronx", state: "NY", zipcode: 10477, date_time: DateTime.parse("17/08/2021 11:00"), host: "Hollywood", about: "Show us what you got")
Tournament.create(name: "Champs", venue: "Clarke Center", street: "11 Clarke Drive", city: "Queens", state: "NY", zipcode: 11238, date_time: DateTime.parse("17/09/2021 14:00"), host: "Beat the Champ", about: "Are you able to beat the reigning champs?")
Tournament.create(name: "Swish Tournament", venue: "HoopTown Post", street: "564 Park Avenue", city: "New York", state: "NY", zipcode: 11234, date_time: DateTime.parse("29/06/2021 1:00"), host: "Give Thanks", about: "Lets do it to save lives.")
Tournament.create(name: "Winner's Circle", venue: "Palisade Park", street: "79 Palisade Road", city: "Jersey City", state: "NJ", zipcode: 17349, date_time: DateTime.parse("17/07/2021 16:00"), host: "Money Ball", about: "Winning team wins money!")
