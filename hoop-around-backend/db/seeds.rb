...
Tournament.create(name: "Hoop Stars", venue: "BKG Gym", street: "231 Ballhill Road", city: "New York", state: "NY", zipcode: 11234, date_time: DateTime.parse("17/08/2021 11:00"), host: "Hollywood", about: "Show us what you got")
Tournament.create(name: "Hoop Stars", venue: "BKG Gym", street: "231 Ballhill Road", city: "New York", state: "NY", zipcode: 11234, date_time: DateTime.parse("17/09/2021 14:00"), host: "Beat the Champ", about: "Are you able to beat the reigning champs?")
Tournament.create(name: "Hoop Stars", venue: "BKG Gym", street: "231 Ballhill Road", city: "New York", state: "NY", zipcode: 11234, date_time: DateTime.parse("29/06/2021 1:00"), host: "Give Thanks", about: "Lets do it to save lives.")
Tournament.create(name: "Hoop Stars", venue: "BKG Gym", street: "231 Ballhill Road", city: "New York", state: "NY", zipcode: 11234, date_time: DateTime.parse("17/07/2021 16:00"), host: "Money Ball", about: "Winning team wins money!")
